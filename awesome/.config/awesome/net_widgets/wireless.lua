...
local function worker(args)
    ...
    local font          = "Heavy Data Nerd Font 11" --args.font or beautiful.font
    ...
    net_text.font = "Heavy Data Nerd Font 11"
    ...
    local function text_grabber()
        ...
        if connected then
            ...
            msg = 
                "<span font_desc=\"Source Code Pro 10\">"..
                "┌["..interface.."]\n"..
                "├ESSID:\t"..essid.."\n"..
                "├IP:\t\t"..inet.."\n"..
                "├BSSID:\t"..mac.."\n"..
...
function wireless:attach(widget, args)
	...
	awful.button({}, 1, function () awful.spawn.with_shell(onclick) end) --function() awful.spawn("./wifi_script.sh")
	    ))
    end
--	widget:connect_signal('button::release', function () awful.spawn("bash wifi_script.sh") end)
