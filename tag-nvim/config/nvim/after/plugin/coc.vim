if !exists("g:started_by_firenvim")
	let g:coc_global_extensions = ['coc-ccls', 'coc-python', 'coc-tsserver', 'coc-eslint', 'coc-prettier', 'coc-css', 'coc-html', 'coc-phpls', 'coc-json',  'coc-sh', 'coc-syntax', 'coc-highlight', 'coc-snippets', 'coc-omni']
